...
# for example: 'python3 -O protocol-pi.py'
if __debug__:
    class dbg:
        msg_id = 0
...
if __name__ == '__main__':
    ...
    # You might need to change this path based on where you cloned the repo. Make sure to change the dataset to whichever one you want.
    process_images(r'~/R2D2_Research/datasets/blackDark_corrected/', protocol())
